...
# Output will be saved as output_watermarked.png
```

**Note**: WebGPU currently has shader compatibility issues (f16 support), so it falls back to CPU with MLAS SIMD optimizations, which works correctly.
