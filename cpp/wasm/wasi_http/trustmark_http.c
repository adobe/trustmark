...
void trustmark_http_list_u32_free(trustmark_http_list_u32_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void trustmark_http_list_u8_free(trustmark_http_list_u8_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void wasi_io_streams_result_list_u8_stream_error_free(wasi_io_streams_result_list_u8_stream_error_t *ptr) {
  if (!ptr->is_err) {
    trustmark_http_list_u8_free(&ptr->val.ok);
  } else {
...
void wasi_http_types_method_free(wasi_http_types_method_t *ptr) {
  switch ((int32_t) ptr->tag) {
    case 9: {
      trustmark_http_string_free(&ptr->val.other);
      break;
    }
  }
}
...
void trustmark_http_option_string_free(trustmark_http_option_string_t *ptr) {
  if (ptr->is_some) {
    trustmark_http_string_free(&ptr->val);
  }
}

void trustmark_http_option_u16_free(trustmark_http_option_u16_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_dns_error_payload_free(wasi_http_types_dns_error_payload_t *ptr) {
  trustmark_http_option_string_free(&ptr->rcode);
  trustmark_http_option_u16_free(&ptr->info_code);
}

void trustmark_http_option_u8_free(trustmark_http_option_u8_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_tls_alert_received_payload_free(wasi_http_types_tls_alert_received_payload_t *ptr) {
  trustmark_http_option_u8_free(&ptr->alert_id);
  trustmark_http_option_string_free(&ptr->alert_message);
}

void trustmark_http_option_u32_free(trustmark_http_option_u32_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_field_size_payload_free(wasi_http_types_field_size_payload_t *ptr) {
  trustmark_http_option_string_free(&ptr->field_name);
  trustmark_http_option_u32_free(&ptr->field_size);
}

void trustmark_http_option_u64_free(trustmark_http_option_u64_t *ptr) {
  if (ptr->is_some) {
  }
}
...
void wasi_http_types_error_code_free(wasi_http_types_error_code_t *ptr) {
  switch ((int32_t) ptr->tag) {
    ...
    case 17: {
      trustmark_http_option_u64_free(&ptr->val.http_request_body_size);
      break;
    }
    case 21: {
      trustmark_http_option_u32_free(&ptr->val.http_request_header_section_size);
      break;
    }
    case 22: {
    ...
    case 23: {
      trustmark_http_option_u32_free(&ptr->val.http_request_trailer_section_size);
      break;
    }
    case 24: {
    ...
    case 26: {
      trustmark_http_option_u32_free(&ptr->val.http_response_header_section_size);
      break;
    }
    case 27: {
    ...
    case 28: {
      trustmark_http_option_u64_free(&ptr->val.http_response_body_size);
      break;
    }
    case 29: {
      trustmark_http_option_u32_free(&ptr->val.http_response_trailer_section_size);
      break;
    }
    case 30: {
    ...
    case 31: {
      trustmark_http_option_string_free(&ptr->val.http_response_transfer_coding);
      break;
    }
    case 32: {
      trustmark_http_option_string_free(&ptr->val.http_response_content_coding);
      break;
    }
    case 38: {
      trustmark_http_option_string_free(&ptr->val.internal_error);
      break;
    }
  }
}
...
void wasi_http_types_field_key_free(wasi_http_types_field_key_t *ptr) {
  trustmark_http_string_free(ptr);
}
...
void trustmark_http_tuple2_field_name_field_value_free(trustmark_http_tuple2_field_name_field_value_t *ptr) {
  wasi_http_types_field_name_free(&ptr->f0);
  wasi_http_types_field_value_free(&ptr->f1);
}

void trustmark_http_list_tuple2_field_name_field_value_free(trustmark_http_list_tuple2_field_name_field_value_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
    trustmark_http_tuple2_field_name_field_value_t *list_ptr = ptr->ptr;
    for (size_t i = 0; i < list_len; i++) {
      trustmark_http_tuple2_field_name_field_value_free(&list_ptr[i]);
    }
    free(list_ptr);
  }
}
...
void trustmark_http_list_field_value_free(trustmark_http_list_field_value_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void trustmark_http_option_duration_free(trustmark_http_option_duration_t *ptr) {
  if (ptr->is_some) {
  }
}
...
void trustmark_http_string_set(trustmark_http_string_t *ret, const char*s) {
  ret->ptr = (uint8_t*) s;
  ret->len = strlen(s);
}

void trustmark_http_string_dup(trustmark_http_string_t *ret, const char*s) {
  ret->len = strlen(s);
  ret->ptr = (uint8_t*) cabi_realloc(NULL, 0, 1, ret->len * 1);
  memcpy(ret->ptr, s, ret->len * 1);
}

void trustmark_http_string_dup_n(trustmark_http_string_t *ret, const char*s, size_t len) {
  ret->len = len;
  ret->ptr = (uint8_t*) cabi_realloc(NULL, 0, 1, ret->len * 1);
  memcpy(ret->ptr, s, ret->len * 1);
}

void trustmark_http_string_free(trustmark_http_string_t *ret) {
  if (ret->len > 0) {
    free(ret->ptr);
  }
  ret->ptr = NULL;
...
void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, trustmark_http_list_u32_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(2*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_io_poll_poll((uint8_t *) (*in).ptr, (*in).len, ptr);
  *ret = (trustmark_http_list_u32_t) { (uint32_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + sizeof(void*)))) };
}
...
void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, trustmark_http_string_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(2*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_io_error_method_error_to_debug_string((self).__handle, ptr);
  *ret = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + sizeof(void*)))) };
}

bool wasi_io_streams_method_input_stream_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, trustmark_http_list_u8_t *ret, wasi_io_streams_stream_error_t *err) {
  __attribute__((__aligned__(sizeof(void*))))
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (trustmark_http_list_u8_t) { (uint8_t*)(*((uint8_t **) (ptr + sizeof(void*)))), (*((size_t*) (ptr + (2*sizeof(void*))))) };
      break;
    }
    case 1: {
      result.is_err = true;
...
bool wasi_io_streams_method_input_stream_blocking_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, trustmark_http_list_u8_t *ret, wasi_io_streams_stream_error_t *err) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(3*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, trustmark_http_list_u8_t *contents, wasi_io_streams_stream_error_t *err) {
...
bool wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, trustmark_http_list_u8_t *contents, wasi_io_streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_http_types_static_fields_from_list(trustmark_http_list_tuple2_field_name_field_value_t *entries, wasi_http_types_own_fields_t *ret, wasi_http_types_header_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, trustmark_http_list_field_value_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(2*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_fields_get((self).__handle, (uint8_t *) (*name).ptr, (*name).len, ptr);
  *ret = (trustmark_http_list_field_value_t) { (wasi_http_types_field_value_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + sizeof(void*)))) };
}
...
bool wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, trustmark_http_list_field_value_t *value, wasi_http_types_header_error_t *err) {
...
void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, trustmark_http_list_tuple2_field_name_field_value_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(2*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_fields_entries((self).__handle, ptr);
  *ret = (trustmark_http_list_tuple2_field_name_field_value_t) { (trustmark_http_tuple2_field_name_field_value_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + sizeof(void*)))) };
}
...
void wasi_http_types_method_incoming_request_method(wasi_http_types_borrow_incoming_request_t self, wasi_http_types_method_t *ret) {
  ...
  switch ((int32_t) variant.tag) {
    ...
    case 9: {
      variant.val.other = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + sizeof(void*)))), (*((size_t*) (ptr + (2*sizeof(void*))))) };
      break;
    }
  }
  *ret = variant;
...
bool wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, trustmark_http_string_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(3*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_incoming_request_path_with_query((self).__handle, ptr);
  trustmark_http_option_string_t option;
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    case 0: {
    ...
    case 1: {
      option.is_some = true;
      option.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + sizeof(void*)))), (*((size_t*) (ptr + (2*sizeof(void*))))) };
      break;
    }
  }
  *ret = option.val;
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    ...
    case 1: {
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 2: {
          variant.val.other = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (2*sizeof(void*))))), (*((size_t*) (ptr + (3*sizeof(void*))))) };
          break;
        }
      }
...
bool wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, trustmark_http_string_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(3*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_http_types_method_outgoing_request_set_method(wasi_http_types_borrow_outgoing_request_t self, wasi_http_types_method_t *method) {
  ...
  switch ((int32_t) (*method).tag) {
    ...
    case 9: {
      const trustmark_http_string_t *payload8 = &(*method).val.other;
      variant = 9;
...
bool wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(3*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *maybe_path_with_query) {
  trustmark_http_option_string_t path_with_query;
  ...
  if ((path_with_query).is_some) {
    const trustmark_http_string_t *payload0 = &(path_with_query).val;
    option = 1;
...
bool wasi_http_types_method_outgoing_request_set_scheme(wasi_http_types_borrow_outgoing_request_t self, wasi_http_types_scheme_t *maybe_scheme) {
  ...
  if ((scheme).is_some) {
    ...
    switch ((int32_t) (*payload0).tag) {
      ...
      case 2: {
        const trustmark_http_string_t *payload3 = &(*payload0).val.other;
        variant = 2;
...
bool wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *ret) {
  __attribute__((__aligned__(sizeof(void*))))
  uint8_t ret_area[(3*sizeof(void*))];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *maybe_authority) {
  trustmark_http_option_string_t authority;
  ...
  if ((authority).is_some) {
    const trustmark_http_string_t *payload0 = &(authority).val;
    option = 1;
    option1 = (uint8_t *) (*payload0).ptr;
    option2 = (*payload0).len;
  } else {
...
bool wasi_http_types_method_request_options_connect_timeout(wasi_http_types_borrow_request_options_t self, wasi_http_types_duration_t *ret) {
  ...
  trustmark_http_option_duration_t option;
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    case 0: {
      option.is_some = false;
      break;
...
bool wasi_http_types_method_request_options_set_connect_timeout(wasi_http_types_borrow_request_options_t self, wasi_http_types_duration_t *maybe_duration) {
  trustmark_http_option_duration_t duration;
    ...
    switch ((int32_t) (*payload0).tag) {
      ...
      case 1: {
        ...
        if (((*payload2).rcode).is_some) {
          const trustmark_http_string_t *payload4 = &((*payload2).rcode).val;
          option = 1;
      ...
      case 14: {
        ...
        if (((*payload23).alert_message).is_some) {
          const trustmark_http_string_t *payload29 = &((*payload23).alert_message).val;
          option30 = 1;
      ...
      case 17: {
        const trustmark_http_option_u64_t *payload35 = &(*payload0).val.http_request_body_size;
        int32_t option38;
        int64_t option39;
      ...
      case 21: {
        const trustmark_http_option_u32_t *payload43 = &(*payload0).val.http_request_header_section_size;
        int32_t option46;
        int32_t option47;
      ...
      case 22: {
        ...
        if ((*payload48).is_some) {
          ...
          if (((*payload50).field_name).is_some) {
            const trustmark_http_string_t *payload52 = &((*payload50).field_name).val;
            option53 = 1;
      ...
      case 23: {
        const trustmark_http_option_u32_t *payload66 = &(*payload0).val.http_request_trailer_section_size;
        int32_t option69;
        int32_t option70;
      ...
      case 24: {
        ...
        if (((*payload71).field_name).is_some) {
          const trustmark_http_string_t *payload73 = &((*payload71).field_name).val;
          option74 = 1;
      ...
      case 26: {
        const trustmark_http_option_u32_t *payload82 = &(*payload0).val.http_response_header_section_size;
        int32_t option85;
        int32_t option86;
      ...
      case 27: {
        ...
        if (((*payload87).field_name).is_some) {
          const trustmark_http_string_t *payload89 = &((*payload87).field_name).val;
          option90 = 1;
      ...
      case 28: {
        const trustmark_http_option_u64_t *payload97 = &(*payload0).val.http_response_body_size;
        int32_t option100;
        int64_t option101;
      ...
      case 29: {
        const trustmark_http_option_u32_t *payload102 = &(*payload0).val.http_response_trailer_section_size;
        int32_t option105;
        int32_t option106;
      ...
      case 30: {
        ...
        if (((*payload107).field_name).is_some) {
          const trustmark_http_string_t *payload109 = &((*payload107).field_name).val;
          option110 = 1;
      ...
      case 31: {
        const trustmark_http_option_string_t *payload117 = &(*payload0).val.http_response_transfer_coding;
        int32_t option120;
        uint8_t * option121;
        size_t option122;
        if ((*payload117).is_some) {
          const trustmark_http_string_t *payload119 = &(*payload117).val;
          option120 = 1;
      ...
      case 32: {
        const trustmark_http_option_string_t *payload123 = &(*payload0).val.http_response_content_coding;
        int32_t option126;
        uint8_t * option127;
        size_t option128;
        if ((*payload123).is_some) {
          const trustmark_http_string_t *payload125 = &(*payload123).val;
          option126 = 1;
      ...
      case 38: {
        const trustmark_http_option_string_t *payload134 = &(*payload0).val.internal_error;
        int32_t option137;
        uint8_t * option138;
        size_t option139;
        if ((*payload134).is_some) {
          const trustmark_http_string_t *payload136 = &(*payload134).val;
          option137 = 1;
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              ...
              switch ((int32_t) variant.tag) {
                ...
                case 1: {
                  trustmark_http_option_string_t option0;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      ...
                      option0.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u16_t option1;
                ...
                case 14: {
                  trustmark_http_option_u8_t option2;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                  ...
                  trustmark_http_option_string_t option3;
                  switch ((int32_t) *((uint8_t*) (ptr + (32+1*sizeof(void*))))) {
                    ...
                    case 1: {
                      ...
                      option3.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+2*sizeof(void*))))), (*((size_t*) (ptr + (32+3*sizeof(void*))))) };
                      break;
                    }
                  }
                ...
                case 17: {
                  trustmark_http_option_u64_t option4;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                ...
                case 21: {
                  trustmark_http_option_u32_t option5;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                ...
                case 22: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      ...
                      trustmark_http_option_string_t option6;
                      switch ((int32_t) *((uint8_t*) (ptr + (32+1*sizeof(void*))))) {
                        case 0: {
                        ...
                        case 1: {
                          ...
                          option6.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+2*sizeof(void*))))), (*((size_t*) (ptr + (32+3*sizeof(void*))))) };
                          break;
                        }
                      }
                      trustmark_http_option_u32_t option7;
                ...
                case 23: {
                  trustmark_http_option_u32_t option9;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                ...
                case 24: {
                  trustmark_http_option_string_t option10;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                    ...
                    case 1: {
                      ...
                      option10.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u32_t option11;
                  switch ((int32_t) *((uint8_t*) (ptr + (32+3*sizeof(void*))))) {
                    case 0: {
                ...
                case 26: {
                  trustmark_http_option_u32_t option12;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                ...
                case 27: {
                  trustmark_http_option_string_t option13;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                    ...
                    case 1: {
                      ...
                      option13.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u32_t option14;
                  switch ((int32_t) *((uint8_t*) (ptr + (32+3*sizeof(void*))))) {
                    case 0: {
                ...
                case 28: {
                  trustmark_http_option_u64_t option15;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                ...
                case 29: {
                  trustmark_http_option_u32_t option16;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                ...
                case 30: {
                  trustmark_http_option_string_t option17;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                    ...
                    case 1: {
                      ...
                      option17.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u32_t option18;
                  switch ((int32_t) *((uint8_t*) (ptr + (32+3*sizeof(void*))))) {
                    case 0: {
                ...
                case 31: {
                  trustmark_http_option_string_t option19;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                    ...
                    case 1: {
                      ...
                      option19.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                ...
                case 32: {
                  trustmark_http_option_string_t option20;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                    ...
                    case 1: {
                      ...
                      option20.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                ...
                case 38: {
                  trustmark_http_option_string_t option21;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                    ...
                    case 1: {
                      ...
                      option21.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    ...
    case 1: {
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 1: {
          trustmark_http_option_string_t option2;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option2.is_some = false;
              break;
            ...
            case 1: {
              option2.is_some = true;
              option2.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          trustmark_http_option_u16_t option3;
        ...
        case 14: {
          trustmark_http_option_u8_t option4;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option4.is_some = false;
              break;
          ...
          trustmark_http_option_string_t option5;
          switch ((int32_t) *((uint8_t*) (ptr + (16+1*sizeof(void*))))) {
            ...
            case 1: {
              option5.is_some = true;
              option5.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+2*sizeof(void*))))), (*((size_t*) (ptr + (16+3*sizeof(void*))))) };
              break;
            }
          }
          variant.val.tls_alert_received = (wasi_http_types_tls_alert_received_payload_t) {
        ...
        case 17: {
          trustmark_http_option_u64_t option6;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option6.is_some = false;
              break;
        ...
        case 22: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option10.is_some = true;
              trustmark_http_option_string_t option8;
              switch ((int32_t) *((uint8_t*) (ptr + (16+1*sizeof(void*))))) {
                case 0: {
                  option8.is_some = false;
                  break;
                ...
                case 1: {
                  option8.is_some = true;
                  option8.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+2*sizeof(void*))))), (*((size_t*) (ptr + (16+3*sizeof(void*))))) };
                  break;
                }
              }
              trustmark_http_option_u32_t option9;
        ...
        case 24: {
          trustmark_http_option_string_t option12;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option12.is_some = false;
              break;
            ...
            case 1: {
              option12.is_some = true;
              option12.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          trustmark_http_option_u32_t option13;
          switch ((int32_t) *((uint8_t*) (ptr + (16+3*sizeof(void*))))) {
            case 0: {
              option13.is_some = false;
              break;
        ...
        case 27: {
          trustmark_http_option_string_t option15;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option15.is_some = false;
              break;
            ...
            case 1: {
              option15.is_some = true;
              option15.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          trustmark_http_option_u32_t option16;
        ...
        case 28: {
          trustmark_http_option_u64_t option17;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option17.is_some = false;
              break;
        ...
        case 30: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option19.is_some = true;
              option19.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          trustmark_http_option_u32_t option20;
          switch ((int32_t) *((uint8_t*) (ptr + (16+3*sizeof(void*))))) {
            case 0: {
              option20.is_some = false;
              break;
        ...
        case 31: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option21.is_some = true;
              option21.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
        ...
        case 32: {
          trustmark_http_option_string_t option22;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option22.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
        ...
        case 38: {
          trustmark_http_option_string_t option23;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option23.is_some = false;
              break;
            ...
            case 1: {
              option23.is_some = true;
              option23.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
              ...
              switch ((int32_t) variant.tag) {
                ...
                case 1: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option.is_some = true;
                      option.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u16_t option0;
                  switch ((int32_t) *((uint8_t*) (ptr + (32+3*sizeof(void*))))) {
                    case 0: {
                      option0.is_some = false;
                      break;
                ...
                case 14: {
                  trustmark_http_option_u8_t option1;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option1.is_some = false;
                      break;
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + (32+1*sizeof(void*))))) {
                    ...
                    case 1: {
                      option2.is_some = true;
                      option2.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+2*sizeof(void*))))), (*((size_t*) (ptr + (32+3*sizeof(void*))))) };
                      break;
                    }
                  }
                  variant.val.tls_alert_received = (wasi_http_types_tls_alert_received_payload_t) {
                ...
                case 17: {
                  trustmark_http_option_u64_t option3;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option3.is_some = false;
                      break;
                ...
                case 21: {
                  trustmark_http_option_u32_t option4;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option4.is_some = false;
                      break;
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      ...
                      switch ((int32_t) *((uint8_t*) (ptr + (32+1*sizeof(void*))))) {
                        ...
                        case 1: {
                          option5.is_some = true;
                          option5.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+2*sizeof(void*))))), (*((size_t*) (ptr + (32+3*sizeof(void*))))) };
                          break;
                        }
                      }
                      trustmark_http_option_u32_t option6;
                      switch ((int32_t) *((uint8_t*) (ptr + (32+4*sizeof(void*))))) {
                        case 0: {
                          option6.is_some = false;
                          break;
                ...
                case 23: {
                  trustmark_http_option_u32_t option8;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option8.is_some = false;
                      break;
                ...
                case 24: {
                  trustmark_http_option_string_t option9;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option9.is_some = false;
                      break;
                    ...
                    case 1: {
                      option9.is_some = true;
                      option9.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u32_t option10;
                  switch ((int32_t) *((uint8_t*) (ptr + (32+3*sizeof(void*))))) {
                    case 0: {
                      option10.is_some = false;
                      break;
                ...
                case 27: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option12.is_some = true;
                      option12.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u32_t option13;
                ...
                case 28: {
                  trustmark_http_option_u64_t option14;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option14.is_some = false;
                      break;
                ...
                case 29: {
                  trustmark_http_option_u32_t option15;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option15.is_some = false;
                      break;
                ...
                case 30: {
                  trustmark_http_option_string_t option16;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option16.is_some = false;
                      break;
                    ...
                    case 1: {
                      option16.is_some = true;
                      option16.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
                  trustmark_http_option_u32_t option17;
                  switch ((int32_t) *((uint8_t*) (ptr + (32+3*sizeof(void*))))) {
                    case 0: {
                      option17.is_some = false;
                      break;
                ...
                case 31: {
                  trustmark_http_option_string_t option18;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option18.is_some = false;
                      break;
                    ...
                    case 1: {
                      option18.is_some = true;
                      option18.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (32+1*sizeof(void*))))), (*((size_t*) (ptr + (32+2*sizeof(void*))))) };
                      break;
                    }
                  }
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 1: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option.is_some = true;
              option.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          trustmark_http_option_u16_t option0;
        ...
        case 14: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + (16+1*sizeof(void*))))) {
            ...
            case 1: {
              option2.is_some = true;
              option2.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+2*sizeof(void*))))), (*((size_t*) (ptr + (16+3*sizeof(void*))))) };
              break;
            }
          }
          variant.val.tls_alert_received = (wasi_http_types_tls_alert_received_payload_t) {
        ...
        case 24: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option9.is_some = true;
              option9.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          trustmark_http_option_u32_t option10;
        ...
        case 30: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option16.is_some = true;
              option16.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          trustmark_http_option_u32_t option17;
        ...
        case 31: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option18.is_some = true;
              option18.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          variant.val.http_response_transfer_coding = option18;
        ...
        case 38: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option20.is_some = true;
              option20.val = (trustmark_http_string_t) { (uint8_t*)(*((uint8_t **) (ptr + (16+1*sizeof(void*))))), (*((size_t*) (ptr + (16+2*sizeof(void*))))) };
              break;
            }
          }
          variant.val.internal_error = option20;
...
extern void __component_type_object_force_link_trustmark_http(void);
__attribute__((used))
void __component_type_object_force_link_trustmark_http_public_use_in_this_compilation_unit(void) {
  __component_type_object_force_link_trustmark_http();
}
