...
#ifndef __BINDINGS_TRUSTMARK_HTTP_H
#define __BINDINGS_TRUSTMARK_HTTP_H
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct trustmark_http_string_t {
  uint8_t*ptr;
  size_t len;
} trustmark_http_string_t;
...
typedef struct {
  uint8_t *ptr;
  size_t len;
} trustmark_http_list_u8_t;

typedef struct {
  bool is_err;
  union {
    trustmark_http_list_u8_t ok;
...
typedef struct {
  bool is_some;
  trustmark_http_string_t val;
} trustmark_http_option_string_t;

typedef struct {
  bool is_some;
  uint16_t val;
} trustmark_http_option_u16_t;

// Defines the case payload type for `DNS-error` above:
typedef struct wasi_http_types_dns_error_payload_t {
  trustmark_http_option_string_t   rcode;
  trustmark_http_option_u16_t   info_code;
} wasi_http_types_dns_error_payload_t;

typedef struct {
  bool is_some;
  uint8_t val;
} trustmark_http_option_u8_t;

// Defines the case payload type for `TLS-alert-received` above:
typedef struct wasi_http_types_tls_alert_received_payload_t {
  trustmark_http_option_u8_t   alert_id;
  trustmark_http_option_string_t   alert_message;
} wasi_http_types_tls_alert_received_payload_t;

typedef struct {
  bool is_some;
  uint32_t val;
} trustmark_http_option_u32_t;

// Defines the case payload type for `HTTP-response-{header,trailer}-size` above:
typedef struct wasi_http_types_field_size_payload_t {
  trustmark_http_option_string_t   field_name;
  trustmark_http_option_u32_t   field_size;
} wasi_http_types_field_size_payload_t;

typedef struct {
  bool is_some;
  uint64_t val;
} trustmark_http_option_u64_t;
...
typedef struct wasi_http_types_error_code_t {
  ...
  union {
    ...
    trustmark_http_option_u64_t     http_request_body_size;
    trustmark_http_option_u32_t     http_request_header_section_size;
    wasi_http_types_option_field_size_payload_t     http_request_header_size;
    trustmark_http_option_u32_t     http_request_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_request_trailer_size;
    trustmark_http_option_u32_t     http_response_header_section_size;
    wasi_http_types_field_size_payload_t     http_response_header_size;
    trustmark_http_option_u64_t     http_response_body_size;
    trustmark_http_option_u32_t     http_response_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_response_trailer_size;
    trustmark_http_option_string_t     http_response_transfer_coding;
    trustmark_http_option_string_t     http_response_content_coding;
    trustmark_http_option_string_t     internal_error;
  } val;
...
typedef trustmark_http_string_t wasi_http_types_field_key_t;
...
} trustmark_http_tuple2_field_name_field_value_t;

typedef struct {
  trustmark_http_tuple2_field_name_field_value_t *ptr;
  size_t len;
} trustmark_http_list_tuple2_field_name_field_value_t;
...
typedef struct {
  ...
  size_t len;
} trustmark_http_list_field_value_t;
...
} trustmark_http_option_duration_t;
...
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, trustmark_http_list_u32_t *ret);
...
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, trustmark_http_string_t *ret);

// Imported Functions from `wasi:io/streams@0.2.2`
extern bool wasi_io_streams_method_input_stream_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, trustmark_http_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
extern bool wasi_io_streams_method_input_stream_blocking_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, trustmark_http_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, trustmark_http_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
extern bool wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, trustmark_http_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_http_types_static_fields_from_list(trustmark_http_list_tuple2_field_name_field_value_t *entries, wasi_http_types_own_fields_t *ret, wasi_http_types_header_error_t *err);
// Get all of the values corresponding to a name. If the name is not present
// in this `fields` or is syntactically invalid, an empty list is returned.
// However, if the name is present but empty, this is represented by a list
// with one or more empty field-values present.
extern void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, trustmark_http_list_field_value_t *ret);
...
extern bool wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, trustmark_http_list_field_value_t *value, wasi_http_types_header_error_t *err);
...
extern void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, trustmark_http_list_tuple2_field_name_field_value_t *ret);
...
extern bool wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, trustmark_http_string_t *ret);
...
extern bool wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, trustmark_http_string_t *ret);
...
extern bool wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *ret);
// Set the combination of the HTTP Path and Query for the Request.
// When `none`, this represents an empty Path and empty Query. Fails is the
// string given is not a syntactically valid path and query uri component.
extern bool wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *maybe_path_with_query);
...
extern bool wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *ret);
// Set the authority of the Request's target URI. A value of `none` may be used
// with Related Schemes which do not require an authority. The HTTP and
// HTTPS schemes always require an authority. Fails if the string given is
// not a syntactically valid URI authority.
extern bool wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, trustmark_http_string_t *maybe_authority);
// Get the headers associated with the Request.
// 
// The returned `headers` resource is immutable: `set`, `append`, and
// `delete` operations will fail with `header-error.immutable`.
